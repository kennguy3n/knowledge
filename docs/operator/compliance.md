...
disclosure) and [`supply-chain.md`](../security/supply-chain.md)
...
| --------- | -------------------- | ------ |
| **CC1** Control environment | Security-critical surfaces are gated by `CODEOWNERS` (crypto, ffi, napi, evidence_store, SECURITY.md → `@kennguy3n`); see [`supply-chain.md`](../security/supply-chain.md). | Partially — org governance is host. |
