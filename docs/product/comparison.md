...
| Connectors | 140 on-device (5 live-verified, rest contract-stable) | M365 + Graph-connected sources | 100+ enterprise sources | Notion + limited integrations | None (BYO embeddings) | SaaS integrations + browser ext. | Notion + limited integrations | Upload + Google Drive/Docs | Limited integrations |
