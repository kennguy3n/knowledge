//! lexoffice connector — lexoffice partner API (`https://api.lexoffice.io/v1`).
//!
...
/// Default lexoffice API base URL.
pub const DEFAULT_API_BASE_URL: &str = "https://api.lexoffice.io/v1";
