//! Personio connector — Personio partner API (`https://api.personio.de/v1`).
//!
...
/// Default Personio API base URL.
pub const DEFAULT_API_BASE_URL: &str = "https://api.personio.de/v1";
