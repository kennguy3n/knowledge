...
//!
//! Per `docs/technical/architecture.md` §2.2 / §9.1 and `docs/technical/design.md` §3.1:
//!
...
/// stored inline. Per `docs/technical/architecture.md` §2.2 and `docs/technical/design.md` §3.1.
