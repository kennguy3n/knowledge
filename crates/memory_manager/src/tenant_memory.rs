...
//!
//! Per `docs/technical/design.md` §4.3 and §6.2, tenant / institutional memory
//! captures the **canonical policy, product taxonomy, and stable org
//! knowledge** that defines the tenant. Items default to
//! [`SensitivityClass::Critical`] which has, per `docs/technical/design.md` §4.3,
...
//! docs** only (see [`ApprovedDocumentRef`] and `docs/technical/design.md` §6.3
...
/// explicitly admitted to feed tenant synthesis. Per `docs/technical/design.md`
