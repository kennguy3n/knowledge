...
//!
//! Per `docs/technical/design.md` §6.4: "the synthesis output is published as an
...
/// hierarchy from `docs/technical/design.md` §6 (User → Channel → Domain →
/// Tenant).
...
pub struct SynthesisObject {
    ...
    /// object's id (per `docs/technical/design.md` §4 — "supersession preferred
