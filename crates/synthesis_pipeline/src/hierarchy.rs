...
//!
//! Per `PROPOSAL.md` §6.3 the substrate has three rules about what
...
///
/// Per `PROPOSAL.md` §6.3 rule 2, domain synthesis consumes channel
...
///
/// Per `PROPOSAL.md` §6.3 rule 3, tenant synthesis consumes domain
