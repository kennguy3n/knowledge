...
//!
//! Per `docs/technical/design.md` §7.3 every agent proposal carries:
//!
...
///
/// Per `docs/technical/design.md` §7.3 every proposal carries the agent identity,
...
///
/// Mirrors the typed-edge taxonomy from `docs/technical/design.md` §3.3. Kept as
