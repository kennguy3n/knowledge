...
The shipped connectors cover the common B2B sources: Google Drive,
OneDrive, Notion, Jira, Confluence, Figma, HubSpot, Slack, and email
(Gmail / Microsoft Graph). One connector (GitHub) is marked **unstable**
— a deliberate maturity signal, described in the
[roadmap](../docs/product/roadmap.md). Connectors typically ship as
unstable until they have soaked against the live API.
