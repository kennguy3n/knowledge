...
def build_report(personas: list[RecapScore], multilingual: list[RecapScore],
    ...
    a("> **See also:** the per-recap scores below are rolled up **per language** "
      "(with a 1.7B-vs-4B model-tier comparison and an honest pending list) in "
      "the public [multilingual leaderboard](multilingual-leaderboard.md), "
      "regenerated by `demos/synthesis-eval/leaderboard.py`.")
    a("")
